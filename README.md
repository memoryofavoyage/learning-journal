...
17/12/2034
Today I need help with a problem I've had before where I get an error trying to attach a script to an object. It was because you can't add a script with an error to an object, so we fixed the errors and fixed an issue where the shutter would close immediately and also immediately go back up. Had to add another "while (Waiting)", and also make it all a while loop so that it will happen when you click on the lever a second time. Right now I'm not sure what to do since I can't add assets, I left my iPad at home in favour of bringing my laptop. Might just say the prototype is done so I can have help getting it ready for submission in lesson.
